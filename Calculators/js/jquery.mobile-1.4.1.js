        ...
        a.extend(a.mobile, {
            ...
            resetActivePageHeight: function (b) {
                var c = a("." + a.mobile.activePageClass),
                    d = c.height(),
                    e = c.outerHeight(!0);
                b = "number" == typeof b ? b : a.mobile.getScreenHeight() //, c.css("border", "1px solid #249AC8") c.css("min-height", b - (e - d))
            },
            loading: function () {
    ...
    function (a, b) {
        a.widget("mobile.button", {
            ...
            _button: function () {
                ...
                return a(this.element.val())  //"<div class='ui-btn ui-input-btn" + (b.wrapperClass ? " " + b.wrapperClass : "") + (b.theme ? " ui-btn-" + b.theme : "") + (b.corners ? " ui-corner-all" : "") + (b.shadow ? " ui-shadow" : "") + (b.inline ? " ui-btn-inline" : "") + (b.mini ? " ui-mini" : "") + (b.disabled ? " ui-state-disabled" : "") + (c ? " " + c : "") + "' >" +  + "</div>")
            },
            widget: function () {
                return this.wrapper
            },
